...
parser = argparse.ArgumentParser(description='Demo RCFRMS')
...
%parser.add_argument('--task', required=True, type=str, help='Task to run', 'Dehazing')
...
load_file = run_path(os.path.join(task, "RCFRMS.py"))
model = load_file['RCFRMS']()
model.cuda()
